...
preal1 <- fread("C:/Users/zhich/Downloads/extracolumns-20230226T083050Z-001/extracolumns/real1-processed.txt")
...
fwrite(pall, "C:/Users/zhich/Downloads/pall.7.txt")

#creating feature subsets
pall <- fread("C:/Users/zhich/Downloads/pall.7.txt")
m1 <- subset(pall, select = c(CALL_mutect2,CALL_freebayes,CALL_vardict,CALL_varscan,FILTER_Mutect2,FILTER_Freebayes,FILTER_Vardict,FILTER_Varscan,m2_MQ,f_MQMR,vs_SSC,vs_SPV,vd_SSF,vd_MSI))
...
save(rf.m1,file="C:/Users/zhich/Downloads/rf.m1.7.14.prob.RData")

#loading random forest model
load("C:/Users/zhich/Downloads/rf.m1.7.14.prob.RData")

#preprocessing test data (real2p2)
preal2p2 <- fread("C:/Users/zhich/Downloads/Telegram Desktop/real2_part2-processed.txt")
...
real2p2m1 <- subset(preal2p2, select = c(CALL_mutect2,CALL_freebayes,CALL_vardict,CALL_varscan,FILTER_Mutect2,FILTER_Freebayes,FILTER_Vardict,FILTER_Varscan,m2_MQ,f_MQMR,vs_SSC,vs_SPV,vd_SSF,vd_MSI))

#generating predictions for test data (real2p2)
probabilities <- as.data.frame(predict(rf.m1, data = real2p2m1, type='response', verbose = TRUE)$predictions)
